          ...
          <div className="w-full flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-10">
              ...
              <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-fg-3 font-[family-name:var(--font-geist-mono)] text-[clamp(0.8rem,1.8vw,0.95rem)]">
                ...
                <span className="text-fg-6">•</span>
                <a href="https://github.com/meanmachine889" target="_blank" rel="noopener noreferrer" className="hover:text-fg transition-colors">github</a>
                <span className="text-fg-6">•</span>
                <a href="https://drive.google.com/file/d/1gcJPKYqwmLngCaruuUED1utYBywRZB6k/view?usp=drive_link" target="_blank" rel="noopener noreferrer" className="hover:text-fg transition-colors">resume</a>
              </div>
            </div>
          </div>
        </div>
