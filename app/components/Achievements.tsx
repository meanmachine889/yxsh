            ...
            >
              ...
              <div className="flex flex-col w-full md:w-1/3 shrink-0 gap-3">
                <div className="flex gap-5 sm:gap-7">
                  <span className="text-[clamp(1.1rem,3vw,1.5rem)] font-[family-name:var(--font-geist-mono)] text-border-1">
                    {item.id}
                  </span>
                  <div>
                    ...
                    <Link
                      ...
                      className="mt-4 text-[clamp(0.75rem,1.5vw,0.85rem)] font-[family-name:var(--font-geist-mono)] text-fg border border-border-1 hover:bg-fg hover:text-bg transition-colors w-max px-4 py-2 rounded-full flex items-center gap-2"
                    >
                      View post
                    </Link>
                  </div>
              ...
              <div className="hidden md:flex flex-col w-full md:w-2/3 md:pt-1">
                <p className="text-fg-3 text-[clamp(0.85rem,2vw,0.95rem)] leading-relaxed max-w-2xl text-left">
                  {item.description}
                </p>
              </div>
            </div>
